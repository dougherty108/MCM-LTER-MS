...
files <- list.files(path = "~/Google Drive/My Drive/EarthEngine", pattern = ".tif", full.names = TRUE)
...
#write_csv(output_to_save, "data/sediment abundance data/LANDSAT_noPan_sediment_abundances_20250218.csv")
